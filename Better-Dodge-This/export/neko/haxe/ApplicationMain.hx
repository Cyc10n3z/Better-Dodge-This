...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Better-Dodge-This", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Better-Dodge-This", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Better-Dodge-This";
		app.meta["name"] = "Better-Dodge-This";
